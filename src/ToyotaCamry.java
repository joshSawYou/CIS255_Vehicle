// Model class
class ToyotaCamry extends ToyotaModels {
   protected String modelName;
   

   public ToyotaCamry(String modelName, MakeType makeType, VehicleType vehicleType, int doorCount, EngineType engineType, String color, int year) {
