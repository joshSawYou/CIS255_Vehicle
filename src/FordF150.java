// Model class
class FordF150 extends FordModels {
    protected String modelName;


   public FordF150(String modelName, MakeType makeType, VehicleType vehicleType, int doorCount, EngineType engineType, String color, int year) {
