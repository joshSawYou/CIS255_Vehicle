// Model class
class FordFiesta extends FordModels {
    protected String modelName;

 

   public FordFiesta(String modelName, MakeType makeType, VehicleType vehicleType, int doorCount, EngineType engineType, String color, int year) {
