// Model class
class FordMustang extends FordModels {
   protected String modelName;
 

   public FordMustang(String modelName, MakeType makeType, VehicleType vehicleType, int doorCount, EngineType engineType, String color, int year) {
