// Model class
class HondaAccord extends HondaModels {
    protected String modelName;


   public HondaAccord(String modelName, MakeType makeType, VehicleType vehicleType, int doorCount, EngineType engineType, String color, int year) {
