// Model class
class ToyotaCorolla extends ToyotaModels {
    protected String modelName;

 

   public ToyotaCorolla(String modelName, MakeType makeType, VehicleType vehicleType, int doorCount, EngineType engineType, String color, int year) {
