// Model class
class DodgeRam2500 extends DodgeModels {
    protected String modelName;

   

   public DodgeRam2500(String modelName, MakeType makeType, VehicleType vehicleType, int doorCount, EngineType engineType, String color, int year) {
