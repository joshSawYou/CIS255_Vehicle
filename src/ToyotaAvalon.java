// Model class
class ToyotaAvalon extends ToyotaModels {
   protected String modelName;


   public ToyotaAvalon(String modelName, MakeType makeType, VehicleType vehicleType, int doorCount, EngineType engineType, String color, int year) {
