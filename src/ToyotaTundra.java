// Model class
class ToyotaTundra extends ToyotaModels {
   protected String modelName;
  

   public ToyotaTundra(String modelName, MakeType makeType, VehicleType vehicleType, int doorCount, EngineType engineType, String color, int year) {
