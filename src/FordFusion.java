// Model class
class FordFusion extends FordModels {
   protected String modelName;



   public FordFusion(String modelName, MakeType makeType, VehicleType vehicleType, int doorCount, EngineType engineType, String color, int year) {
