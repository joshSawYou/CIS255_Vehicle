// Model class
class HondaCivic extends HondaModels {
    protected String modelName;



   public HondaCivic(String modelName, MakeType makeType, VehicleType vehicleType, int doorCount, EngineType engineType, String color, int year) {
