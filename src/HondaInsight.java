// Model class
class HondaInsight extends HondaModels {
   protected String modelName;


   public HondaInsight(String modelName, MakeType makeType, VehicleType vehicleType, int doorCount, EngineType engineType, String color, int year) {
