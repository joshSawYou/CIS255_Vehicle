// Model class
class ToyotaSupra extends ToyotaModels {
   protected String modelName;
 

   public ToyotaSupra(String modelName, MakeType makeType, VehicleType vehicleType, int doorCount, EngineType engineType, String color, int year) {
