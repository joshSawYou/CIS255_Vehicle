// Model class
class TeslaModel3 extends TeslaModels {
   protected String modelName;

   
   public TeslaModel3(String modelName, MakeType makeType, VehicleType vehicleType, int doorCount, EngineType engineType, String color, int year) {
