// Model class
class DodgeCharger extends DodgeModels {
   protected String modelName;
   

   public DodgeCharger(String modelName, MakeType makeType, VehicleType vehicleType, int doorCount, EngineType engineType, String color, int year) {
