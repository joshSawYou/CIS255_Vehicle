// Model class
class HondaRidgeline extends HondaModels {
    protected String modelName;


   public HondaRidgeline(String modelName, MakeType makeType, VehicleType vehicleType, int doorCount, EngineType engineType, String color, int year) {
