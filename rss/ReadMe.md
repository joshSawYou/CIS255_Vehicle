...
Vehicle_UML_DodgeHornet.png purpose: This is a unique model abstract class that inherites the public DodgeModels class. Keep in mind that because it inherites the DodeModels class it gains all of the attributes, methods, and relationships from the this class (by this I mean: since this is a child class of its model class and its model class is a child of the make class which is a child of the type class which is a child of the vehicle class, it inherites all attributes and methods and all inheritances/associations from all of these classes)
...
Vehicle_UML_FordF150.png
   This is a unique model abstract class that inherites the public FordModels class. Keep in mind that because it inherites the FordModels class it gains all of the attributes, methods, and relationships from the this class (by this I mean: since this is a child class of its model class and its model class is a child of the make class which is a child of the type class which is a child of the vehicle class, it inherites all attributes and methods and all inheritances/associations from all of these classes)
...
Vehicle_UML_HondaAccord.png
     This is a unique model abstract class that inherites the public HondaModels class. Keep in mind that because it inherites the HondaModels class it gains all of the attributes, methods, and relationships from the this class (by this I mean: since this is a child class of its model class and its model class is a child of the make class which is a child of the type class which is a child of the vehicle class, it inherites all attributes and methods and all inheritances/associations from all of these classes)
...
Vehicle_UML_TeslaModel3.png
 This is a unique model abstract class that inherites the public TeslaModels class. Keep in mind that because it inherites the TeslaModels class it gains all of the attributes, methods, and relationships from the this class (by this I mean: since this is a child class of its model class and its model class is a child of the make class which is a child of the type class which is a child of the vehicle class, it inherites all attributes and methods and all inheritances/associations from all of these classes)
Vehicle_UML_TeslaModelS.png
   This is a unique model abstract class that inherites the public TeslaModels class. Keep in mind that because it inherites the TeslaModels class it gains all of the attributes, methods, and relationships from the this class (by this I mean: since this is a child class of its model class and its model class is a child of the make class which is a child of the type class which is a child of the vehicle class, it inherites all attributes and methods and all inheritances/associations from all of these classes)
Vehicle_UML_ToyotaSupra.png
   This is a unique model abstract class that inherites the public ToyotaModels class. Keep in mind that because it inherites the ToyotaModels class it gains all of the attributes, methods, and relationships from the this class (by this I mean: since this is a child class of its model class and its model class is a child of the make class which is a child of the type class which is a child of the vehicle class, it inherites all attributes and methods and all inheritances/associations from all of these classes)
